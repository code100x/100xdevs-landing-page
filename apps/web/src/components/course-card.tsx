...
export function CourseCard({ course }: { course: any }) {
  return (
    <div className="flex flex-col relative mr-4 ml-7 justify-evenly">
      <Image
